...
// `internal` (not public) — used only by BIP39 entropy-to-mnemonic conversion
// above, but kept at module-level `internal` so `@testable import CoreNostr`
// can exercise it from the test suite.
extension String {
